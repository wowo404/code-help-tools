...
public class GenerateMapper {
    //生成Mapper类
    public static void generate(String entityName, String entityPackage, String mapperPackage, String mapperPath, String entitySuffix) throws IOException {
        File file = new File(mapperPath + entityName + "Dao.java");
