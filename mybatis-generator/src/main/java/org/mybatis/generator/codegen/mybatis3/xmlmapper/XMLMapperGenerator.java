...
import org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.WhereColumnListElementGenerator;
...
public class XMLMapperGenerator extends AbstractXmlGenerator {
    ...
    protected XmlElement getSqlMapElement() {
        ...
        //生成各种sql
        addResultMapWithoutBLOBsElement(answer);//不带blob字段的resultMap
        addResultMapWithBLOBsElement(answer);//带blob字段
        addExampleWhereClauseElement(answer);
        addMyBatis3UpdateByExampleWhereClauseElement(answer);
        addBaseColumnListElement(answer);//字段基本元素节点
        addBlobColumnListElement(answer);
        addWhereColumnListElement(answer);//20170307，where_column
    ...
    protected void addWhereColumnListElement(XmlElement parentElement) {
    	AbstractXmlElementGenerator elementGenerator = new WhereColumnListElementGenerator();
        initializeAndExecuteGenerator(elementGenerator, parentElement);
	}
