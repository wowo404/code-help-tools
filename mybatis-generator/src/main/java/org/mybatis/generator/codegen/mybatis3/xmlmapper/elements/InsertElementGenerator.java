...
public class InsertElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        //20170301，getAliasedFullyQualifiedTableNameAtRuntime会获取到schema.tableName，这里修改成只拼接tableName
        insertClause.append(introspectedTable.getFullyQualifiedTable().getIntrospectedTableName());
