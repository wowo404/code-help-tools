...
public abstract class IntrospectedTable {
    ...
    protected enum InternalAttribute {
        ...
        /**add by liuzhsh,20170926,where column list id*/
        ATTR_WHERE_COLUMN,
    ...
    protected void calculateXmlAttributes() {
        ...
        setWhereColumn("where_column");//add by liuzhsh,20170926
        setBlobColumnListId("Blob_Column_List"); //$NON-NLS-1$
        setMyBatis3UpdateByExampleWhereClauseId("Update_By_Example_Where_Clause"); //$NON-NLS-1$
    }

    /**
     * add by liuzhsh,20170926
     */
    private void setWhereColumn(String s) {
    	internalAttributes.put(InternalAttribute.ATTR_WHERE_COLUMN, s);
	}
